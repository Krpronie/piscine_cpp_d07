...
Toy::Toy(Toy const& other) :_type(other.getType()), _name(other.getName()), _picture(other._picture){

    }

Toy::Toy(ToyType type, std::string const& name, std::string const& filename) :_type(type), _name(name), _picture(filename){
